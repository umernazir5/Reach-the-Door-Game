...
namespace Game_app
{
    public partial class Level3 : Form
    {
        ...
        private void gameLoop_Tick(object sender, EventArgs e) => game.Update();
        ...
        {
            gameLoop.Stop();
            // Level1 -> Level2 -> Level3 -> BossVideo -> FinalBoss
            NextLevel transition = new NextLevel(() => new UI.BossVideo());
            transition.Show();
            this.Hide();
        }
